        ...
        for root, dirs, files in os.walk(source_path):
            ...
            for file in files:
                ...
                if file in skip_files:
                    print(f"⚠️  Preserving user file: {file}")
                    continue
                ...
                for attempt in range(5):  # Up to 5 attempts
                    try:
                        ...
                        if attempt < 4:  # Not last attempt
                            ...
                            print(
                                f"❌ Failed to copy {rel_path} after all attempts: {e}"
                            )
                            error_count += 1
                ...
                try:
                    ...
                    if poll_result is None:  # Process is still running
                        ...
                        if exe_path.name in result.stdout:
                            print("✅ Application confirmed running in task list!")
                            return True
                        else:
                            print("⚠️  Application not found in task list, but process seems active")
                            return True
                    else:
                    ...
                    print("⚠️  Timeout while checking application status, but it may have started")
                    return True
                except Exception as e:
...
def main():
    ...
    if install_update(source_dir, target_dir, backup_dir):
        ...
        if restart_success:
            ...
            print("⚠️  Update completed but application restart failed.")
            print(
