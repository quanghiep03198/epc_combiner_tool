vi_dictionary: dict = {
    ...
    "fields": {
        ...
        "cust_shoe_style": "Hình thể khách",
        "factory_shoe_style": "Hình thể xưởng",
    ...
    "notification": {
        ...
        "combine_epc_success": "{quantity} tem đã được phối thành công.",
        "combine_epc_validation_failure_text": "Vui lòng kiểm tra lại và điền đầy đủ thông tin phối đôi.",
        "confirm_migrate_suborder": "Bạn có chắc chắn muốn tách {additional_qty} tem size '{size_numcode}' từ tiểu chỉ lệnh '001' sang tiểu chỉ lệnh '{mo_noseq}' không?",
        ...
        "recent_combined_epc_exists_text": "Vui lòng kiểm tra các tem được đánh dấu đỏ, xóa chúng và thay thế bằng các tem khác để đảm bảo số lượng chính xác.",
        "recent_combined_epc_exists_title": "Tồn tại tem vừa mới phối, không thể phối lại.",
